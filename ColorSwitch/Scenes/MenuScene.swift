...
class MenuScene: SKScene {
    ...
    func addLables() {
        let playLabel = SKLabelNode(text: "Нажмите!")
        ...
        let highScoreLabel = SKLabelNode(text: "Лучший счёт: \(UserDefaults.standard.integer(forKey: "HighScore"))")
        ...
        let recentScoreLab = SKLabelNode(text: "Счёт: \(UserDefaults.standard.integer(forKey: "RecentScore"))")
